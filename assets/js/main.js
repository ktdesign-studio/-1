...
(function () {
  ...
  var I18N = {
    ru: {
      ...
      "hero.stat1": "лет в IT",
      "hero.stat2": "воркшопов и вебинаров",
      "hero.stat3": "обученных специалистов",
      ...
      "about.lead": "В IT с 2010 года: прошла путь от системного аналитика до продакт-менеджера в VK. Последние два года мой фокус — искусственный интеллект.",
      "about.body": "Внедряю LLM в продуктовые процессы, проектирую AI-агентов и учу команды работать с нейросетями так, чтобы это давало измеримый результат, а не красивые демо. Веду корпоративные курсы и открытые воркшопы: от промпт-инжиниринга до сборки кликабельных прототипов с AI.",
      "about.fact1": "Продакт-менеджер, запуск корпоративных AI-воркшопов",
      ...
      "exp.title": "Опыт",
      "exp.i1.period": "сейчас",
      "exp.i1.role": "AI Product Manager — VK",
      "exp.i1.desc": "Развиваю продукт и внедряю AI в процессы команды. Запустила серию корпоративных воркшопов по нейросетям для сотрудников VK.",
      "exp.i1.tag3": "Обучение команд",
      "exp.i2.period": "параллельно",
      "exp.i2.role": "Ведущий тренер — Systems.Education",
      "exp.i2.desc": "Соавтор и тренер курса «AI-driven разработка требований и проектирование решений»: учу IT-специалистов создавать требования с помощью ИИ — без галлюцинаций.",
      "exp.i2.tag1": "Курсы",
      ...
      "exp.i4.period": "до этого",
      "exp.i4.role": "Системный и бизнес-аналитик",
      "exp.i4.desc": "Более 7 лет в анализе: требования, интеграции, финтех-продукты. Эта база помогает внедрять AI туда, где он реально нужен.",
      "exp.i4.tag1": "Финтех",
      "exp.i4.tag2": "Требования",
      "exp.i4.tag3": "Интеграции",
    ...
    en: {
      ...
      "hero.stat2": "workshops & webinars",
      "hero.stat3": "professionals trained",
      ...
      "about.lead": "In IT since 2010: from systems analyst to product manager at VK. For the past two years my focus has been artificial intelligence.",
      "about.body": "I integrate LLMs into product processes, design AI agents and teach teams to work with neural networks in a way that delivers measurable results — not just pretty demos. I run corporate courses and public workshops: from prompt engineering to building clickable prototypes with AI.",
      "about.fact1": "Product manager, launched corporate AI workshops",
      ...
      "exp.i1.period": "now",
      "exp.i1.role": "AI Product Manager — VK",
      "exp.i1.desc": "Growing the product and embedding AI into team processes. Launched a series of corporate AI workshops for VK employees.",
      "exp.i1.tag3": "Team training",
      "exp.i2.period": "in parallel",
      "exp.i2.role": "Lead Trainer — Systems.Education",
      "exp.i2.desc": "Co-author and trainer of the “AI-driven requirements engineering and solution design” course: teaching IT specialists to craft requirements with AI — hallucination-free.",
      "exp.i2.tag1": "Courses",
      ...
      "exp.i4.period": "before that",
      "exp.i4.role": "Systems & Business Analyst",
      "exp.i4.desc": "7+ years in analysis: requirements, integrations, fintech products. This foundation helps me bring AI where it truly matters.",
      "exp.i4.tag1": "Fintech",
      "exp.i4.tag2": "Requirements",
      "exp.i4.tag3": "Integrations",
